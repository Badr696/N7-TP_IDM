...
public interface PDL1Package extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Gestionressource</b></em>' reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int WORK_DEFINITION__GESTIONRESSOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int WORK_DEFINITION__LINKS_TO_PREDECESSORS = PROCESS_ELEMENT_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int WORK_DEFINITION__LINKS_TO_SUCCESSORS = PROCESS_ELEMENT_FEATURE_COUNT + 3;
  ...
  /**
   * The meta object id for the '{@link fr.n7.pDL1.impl.GestionRessourcesImpl <em>Gestion Ressources</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL1.impl.GestionRessourcesImpl
   * @see fr.n7.pDL1.impl.PDL1PackageImpl#getGestionRessources()
   * @generated
   */
  int GESTION_RESSOURCES = 4;
   ...
   * @ordered
   */
  int RESSOURCE__QUANTITE = PROCESS_ELEMENT_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.ProcessElement#getProcess <em>Process</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Process</em>'.
   * @see fr.n7.pDL1.ProcessElement#getProcess()
  ...
  /**
   * Returns the meta object for the reference list '{@link fr.n7.pDL1.WorkDefinition#getGestionressource <em>Gestionressource</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Gestionressource</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getGestionressource()
   * @see #getWorkDefinition()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.WorkDefinition#getLinksToPredecessors <em>Links To Predecessors</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Links To Predecessors</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getLinksToPredecessors()
   * @see #getWorkDefinition()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.WorkDefinition#getLinksToSuccessors <em>Links To Successors</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Links To Successors</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getLinksToSuccessors()
   * @see #getWorkDefinition()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link fr.n7.pDL1.GestionRessources <em>Gestion Ressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Gestion Ressources</em>'.
   * @see fr.n7.pDL1.GestionRessources
   * @generated
   */
  EClass getGestionRessources();

  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.GestionRessources#getQuantite <em>Quantite</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Quantite</em>'.
   * @see fr.n7.pDL1.GestionRessources#getQuantite()
  ...
  /**
   * Returns the meta object for the reference list '{@link fr.n7.pDL1.GestionRessources#getRessources <em>Ressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Ressources</em>'.
   * @see fr.n7.pDL1.GestionRessources#getRessources()
   * @see #getGestionRessources()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.GestionRessources#isUtilisee <em>Utilisee</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Utilisee</em>'.
   * @see fr.n7.pDL1.GestionRessources#isUtilisee()
   * @see #getGestionRessources()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.Guidance#getElements <em>Elements</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Gestionressource</b></em>' reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    /**
     * The meta object literal for the '{@link fr.n7.pDL1.impl.GestionRessourcesImpl <em>Gestion Ressources</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL1.impl.GestionRessourcesImpl
     * @see fr.n7.pDL1.impl.PDL1PackageImpl#getGestionRessources()
