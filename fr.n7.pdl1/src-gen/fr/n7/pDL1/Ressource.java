 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL1.Ressource#getQuantite <em>Quantite</em>}</li>
...
public interface Ressource extends ProcessElement
{
   ...
   * @see #setQuantite(int)
   * @see fr.n7.pDL1.PDL1Package#getRessource_Quantite()
   * @model
   * @generated
   */
  int getQuantite();
  ...
  /**
   * Sets the value of the '{@link fr.n7.pDL1.Ressource#getQuantite <em>Quantite</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
