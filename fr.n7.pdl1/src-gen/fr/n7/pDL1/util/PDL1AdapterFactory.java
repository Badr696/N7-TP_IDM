...
public class PDL1AdapterFactory extends AdapterFactoryImpl
{
  ...
  protected PDL1Switch<Adapter> modelSwitch =
    new PDL1Switch<Adapter>()
    {
      ...
      @Override
      public Adapter caseGestionRessources(GestionRessources object)
      {
        return createGestionRessourcesAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL1.GestionRessources <em>Gestion Ressources</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createGestionRessourcesAdapter()
  {
    return null;
  }
