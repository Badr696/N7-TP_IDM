 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL1.impl.RessourceImpl#getQuantite <em>Quantite</em>}</li>
...
public class RessourceImpl extends ProcessElementImpl implements Ressource
{
  ...
  public void setQuantite(int newQuantite)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDL1Package.RESSOURCE__QUANTITE, oldQuantite, quantite));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDL1Package.RESSOURCE__QUANTITE:
        return getQuantite();
