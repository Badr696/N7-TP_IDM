 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL1.impl.GestionRessourcesImpl#getQuantite <em>Quantite</em>}</li>
 *   <li>{@link fr.n7.pDL1.impl.GestionRessourcesImpl#getRessources <em>Ressources</em>}</li>
 *   <li>{@link fr.n7.pDL1.impl.GestionRessourcesImpl#isUtilisee <em>Utilisee</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GestionRessourcesImpl extends ProcessElementImpl implements GestionRessources
{
  ...
  {
    return PDL1Package.Literals.GESTION_RESSOURCES;
  }
  ...
  public void setQuantite(int newQuantite)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDL1Package.GESTION_RESSOURCES__QUANTITE, oldQuantite, quantite));
  }
  ...
  public EList<Ressource> getRessources()
  {
    if (ressources == null)
    {
      ressources = new EObjectResolvingEList<Ressource>(Ressource.class, this, PDL1Package.GESTION_RESSOURCES__RESSOURCES);
    }
    return ressources;
  }
  ...
  public void setUtilisee(boolean newUtilisee)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDL1Package.GESTION_RESSOURCES__UTILISEE, oldUtilisee, utilisee));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDL1Package.GESTION_RESSOURCES__QUANTITE:
        return getQuantite();
      case PDL1Package.GESTION_RESSOURCES__RESSOURCES:
        return getRessources();
      case PDL1Package.GESTION_RESSOURCES__UTILISEE:
        return isUtilisee();
    }
